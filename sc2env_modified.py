...
class SC2Env(environment.Base):
  ...
  def is_available(self, action_id):
    """
    Added by @danielfirebanks
    Check if a specific action is available for the current state of the game"""
  ...
  def step(self, actions):
    """Apply actions, step the world forward, and return observations.
        ...
        MODIFICATIONS: Calls transform_raw instead of self.features.transform_action()
    """
